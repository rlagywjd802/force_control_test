...
void spline_cpp_api(const mxArray * const prhs[2], int32_T nlhs, const mxArray
                    *plhs[1])
{
  emxArray_real_T *x;
  emxArray_real_T *y;
  ...
  emxInit_real_T(&st, &coefs, 2, true);
  ...
  spline_cpp(x, y, coefs);

  /* Marshall function outputs */
  coefs->canFreeData = false;
...
void spline_cpp_atexit(void)
{
  ...
  spline_cpp_xil_terminate();
  spline_cpp_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}

void spline_cpp_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
void spline_cpp_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_spline_cpp_api.c) */
