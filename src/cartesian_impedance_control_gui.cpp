    ...
    while (running) {
      ...
      if (print_data.mutex.try_lock()) {
        // if (print_data.has_data) {
          ...
          marker.pose.position.x = print_data.robot_state.O_T_EE[13];
          marker.pose.position.y = print_data.robot_state.O_T_EE[14];
          marker.pose.position.z = print_data.robot_state.O_T_EE[15];
