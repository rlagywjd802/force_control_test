...
int main(int argc, char** argv) {
  try {
    ...
    std::array<double, 3> x_goal = {{0.301456,0.2222842,0.407501}}; // 0.301456,0.0222842,0.437501
    ...
    CMotionGenerator cartesian_motion_generator(1.0, x_goal);
    std::cout << "WARNING: This example will move the robot! "
              << "Please make sure to have the user stop button at hand!" << std::endl
              << "Press Enter to continue..." << std::endl;
    std::cin.ignore();
    robot.control(cartesian_motion_generator);
