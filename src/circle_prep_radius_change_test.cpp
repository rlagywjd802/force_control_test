...
int main(int argc, char** argv) {
  ...
  const double kPrepR = 0.0204; // layer1
  ...
  double nrgamma2 = 0.0;
  double nrgamma3 = 0.0;
  //butterworth low pass filter - 2nd order, Wn: 0.05
  ...
  // Publisher
  ros::init(argc, argv, "circle_prep_radius_change_test");
  ros::NodeHandle nh;
