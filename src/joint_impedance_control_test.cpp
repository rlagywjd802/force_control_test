...
int main(int argc, char** argv) {
  ...
  try {
    ...
    const std::array<double, 7> k_gains = {{300.0, 100.0, 100.0, 100.0, 125.0, 125.0, 50.0}};
    // Damping
    const std::array<double, 7> d_gains = {{50.0, 50.0, 50.0, 50.0, 30.0, 25.0, 15.0}};
    // const std::array<double, 7> d_gains = {{25.0, 25.0, 25.0, 50.0, 30.0, 25.0, 15.0}};
